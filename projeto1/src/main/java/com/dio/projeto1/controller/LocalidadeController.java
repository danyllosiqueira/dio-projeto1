...
import com.dio.projeto1.model.Localidade;
import com.dio.projeto1.service.LocalidadeService;
...
public class LocalidadeController {
	...
	@PostMapping
	public Localidade create(@RequestBody Localidade entidade) {
	...
	@PutMapping
	public Localidade update(@RequestBody Localidade entidade) {
