...
import com.dio.projeto1.model.Empresa;
import com.dio.projeto1.service.EmpresaService;
...
public class EmpresaController {
	...
	@PostMapping
	public Empresa create(@RequestBody Empresa entidade) {
	...
	@PutMapping
	public Empresa update(@RequestBody Empresa entidade) {
